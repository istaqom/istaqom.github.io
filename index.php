...
<body class="pb-10 pt-10">
  <div class="gradient bg-white rounded-lg container mx-auto w-4/5">
    <div class="flex justify-center pt-4">
      ...
      <p class="roboto-500 sm:text-1xl md:text-3xl lg:text-4xl xl:text-5xl text-center pb-2">
        Hello, I'm Istaqom Wirawan Adi Pratama
      </p>

      <p class="roboto-300 sm:text-lg md:text-1xl lg:text-2xl xl:text-3xl text-center pl-2 pr-2 pb-10">
      ...
      <!--Languages-->
      <p class="roboto-500 sm:text-1xl md:text-3xl lg:text-4xl xl:text-5xl text-center pt-2 pl-2 pr-2 pb-2">
        Languages
      </p>
      ...
      <div class="grid justify-center grid-flow-col justify-item-center gap-8 pb-20 pl-2 pr-2">
        <div>
          <img src="img/php.svg" class="h-32 w-32 pb-2">
        ...
        <div>
          <img src="img/html-5.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            HTML
          </p>
        </div>
        ...
        <div>
          <img src="img/css-3.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            CSS
          </p>
        </div>
        ...
        <div>
          <img src="img/python.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            Python
          </p>
        </div>
      ...
      <div class="grid justify-center grid-flow-col justify-item-center gap-8 pb-20 pl-2 pr-2">
        <div>
          <img src="img/laravel.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            Laravel
          </p>
        </div>
        ...
        <div>
          <img src="img/jquery.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            jQuery
          </p>
        </div>
        ...
        <div>
          <img src="img/tailwind-css.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            Tailwind CSS
          </p>
        </div>
      ...
      <div class="grid justify-center grid-flow-col justify-item-center gap-8 pb-20 pl-2 pr-2">
        <div>
          <img src="img/vscode.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            Visual Code
          </p>
        </div>
        ...
        <div>
          <img src="img/git.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            Git
          </p>
        </div>
        ...
        <div>
          <img src="img/npm.svg" class="h-32 w-32 pb-2">
          <p class="roboto-400 sm:text-lg md:text-lg lg:text-xl xl:text-1xl text-center pb-10">
            NPM
          </p>
        </div>
